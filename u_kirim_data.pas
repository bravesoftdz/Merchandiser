...
begin
  ...
  try
    ...
    fungsi.savetofile(dm.Q_Exe,
      'select * from tb_login_kasir where kd_perusahaan=' + QuotedStr(dm.kd_perusahaan)
      + ' and date(tanggal)=' + QuotedStr(formatdatetime('yyyy-MM-dd', edt_kirim.date))
      + '', namafile);
    ...
    fungsi.savetofile(dm.Q_Exe,
      'select * from tb_jual_batal	 where kd_perusahaan=' + QuotedStr(dm.kd_perusahaan)
      + ' and tgl_transaksi=' + QuotedStr(formatdatetime('yyyy-MM-dd', edt_kirim.date))
      + '', namafile);
    ...
    fungsi.savetofile(dm.Q_Exe,
      'select * from tb_jual_global	 where kd_perusahaan=' + QuotedStr(dm.kd_perusahaan)
      + ' and tgl_transaksi=' + QuotedStr(formatdatetime('yyyy-MM-dd', edt_kirim.date))
      + '', namafile);
    ...
    fungsi.savetofile(dm.Q_Exe,
      ...
      + ' and tgl=' + QuotedStr(formatdatetime('yyyy-MM-dd', edt_kirim.date)) +
      '', namafile);
    ...
    fungsi.savetofile(dm.Q_Exe,
      'select * from tb_koreksi_global	 where kd_perusahaan=' + QuotedStr(dm.kd_perusahaan)
      + ' and tgl_koreksi=' + QuotedStr(formatdatetime('yyyy-MM-dd', edt_kirim.date))
      + '', namafile);
    ...
    fungsi.savetofile(dm.Q_Exe,
      'select * from tb_koreksi_rinci	 where kd_perusahaan=' + QuotedStr(dm.kd_perusahaan)
      + ' and tgl_koreksi=' + QuotedStr(formatdatetime('yyyy-MM-dd', edt_kirim.date))
      + '', namafile);
    ...
    fungsi.savetofile(dm.Q_Exe,
      'select * from tb_purchase_global	 where kd_perusahaan=' + QuotedStr(dm.kd_perusahaan)
      + ' and tgl_purchase=' + QuotedStr(formatdatetime('yyyy-MM-dd', edt_kirim.date))
      + '', namafile);
    ...
    fungsi.savetofile(dm.Q_Exe,
      'select * from tb_purchase_rinci	 where kd_perusahaan=' + QuotedStr(dm.kd_perusahaan)
      + ' and tgl_purchase=' + QuotedStr(formatdatetime('yyyy-MM-dd', edt_kirim.date))
      + '', namafile);
    ...
    fungsi.savetofile(dm.Q_Exe,
      'select * from tb_receipt_global	 where kd_perusahaan=' + QuotedStr(dm.kd_perusahaan)
      + ' and tgl_receipt=' + QuotedStr(formatdatetime('yyyy-MM-dd', edt_kirim.date))
      + '', namafile);
    ...
    fungsi.savetofile(dm.Q_Exe,
      'select * from tb_receipt_rinci	 where kd_perusahaan=' + QuotedStr(dm.kd_perusahaan)
      + ' and tgl_receipt=' + QuotedStr(formatdatetime('yyyy-MM-dd', edt_kirim.date))
      + '', namafile);
    ...
    fungsi.savetofile(dm.Q_Exe,
      'select * from tb_return_global	 where kd_perusahaan=' + QuotedStr(dm.kd_perusahaan)
      + ' and tgl_return=' + QuotedStr(formatdatetime('yyyy-MM-dd', edt_kirim.date))
      + '', namafile);
    ...
    fungsi.savetofile(dm.Q_Exe,
      'select * from tb_return_rinci	 where kd_perusahaan=' + QuotedStr(dm.kd_perusahaan)
      + ' and tgl_return=' + QuotedStr(formatdatetime('yyyy-MM-dd', edt_kirim.date))
      + '', namafile);
    ...
    fungsi.savetofile(dm.Q_Exe,
      'select * from tb_return_jual_global where kd_perusahaan=' + QuotedStr(dm.kd_perusahaan)
      + ' and tgl_return_jual=' + QuotedStr(formatdatetime('yyyy-MM-dd',
      edt_kirim.date)) + '', namafile);
    zipp.AddFiles(dir_zip + '\tb_return_jual_global.cbT', 0);
    sg_load.Progress := 14;

    namafile := dir_simpan + '\tb_return_jual_rinci.cbT';
    fungsi.savetofile(dm.Q_Exe,
      'select * from tb_return_jual_rinci where kd_perusahaan=' + QuotedStr(dm.kd_perusahaan)
      + ' and tgl_return_jual=' + QuotedStr(formatdatetime('yyyy-MM-dd',
      edt_kirim.date)) + '', namafile);
    ...
    fungsi.savetofile(dm.Q_Exe,
      'select * from tb_export_import where kd_perusahaan=' + QuotedStr(dm.kd_perusahaan)
      + ' and date(tanggal)=' + QuotedStr(formatdatetime('yyyy-MM-dd', edt_kirim.date))
      + '', namafile);
